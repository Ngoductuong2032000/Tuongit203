<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Dattour.aspx.cs" Inherits="WebApplication1.Dattour" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="imgs/logo-du-lich(53).jfif" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <a class="text-body" href="homepage.aspx"><< Quay về trang chủ</a><br>
               </div>
            </div>
