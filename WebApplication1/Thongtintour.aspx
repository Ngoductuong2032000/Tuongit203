<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="Thongtintour.aspx.cs" Inherits="WebApplication1.Thongtintour" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="150px" class="auto-style2"  />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:Button class="form-control btn-success" ID="Btntim" runat="server" Text="Go" OnClick="Btntim_Click" />
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropKS" runat="server">
                              <asp:ListItem Text="3107-1" Value="3107-1" />
                              <asp:ListItem Text="Bình Minh" Value="Bình Minh" />
                               <asp:ListItem Text="3107-3" Value="3107-3" />
                              <asp:ListItem Text="3107-2" Value="3107-2" />
                        ...
                        <div class="form-group">
                           <asp:ListBox CssClass="form-control" ID="ListKV" runat="server" SelectionMode="Multiple" Rows="5">
                              ...
                              <asp:ListItem Text="Hoài Bão" Value="Hoài Bão" />
                               ...
                               <asp:ListItem Text="Phú Quốc" Value="Phú Quốc" />
                  ...
                  <div class="row">
                     <div class="col-4">
                        <asp:Button ID="Btnadd" class="btn btn-lg btn-block btn-dark" runat="server" Text="Thêm" OnClick="Btnadd_Click" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Btnup" class="btn btn-lg btn-block bg-warning" runat="server" Text="Cập nhật" OnClick="Btnup_Click" />
                     </div>
                     <div class="col-4">
                   ...
                   <a class="text-body" href="homepage.aspx"><< Back to Home</a><br>
               </div>
            </div>
                                 ...
                                 <ItemTemplate>
                                    <div class="container-fluid">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-2">
                                             <asp:Image  ID="Image1" runat="server" ImageUrl='<%# Eval("Hinh") %>' class="auto-style3"/>
                                          </div>
                                       </div>
                                    </div>
                                 </ItemTemplate>
